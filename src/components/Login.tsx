...
export default function Login({ onLoginSuccess }: LoginProps) {
  ...
  useEffect(() => {
    ...
    const lowBandwidth = Boolean(connection?.saveData) || ['slow-2g', '2g', '3g'].includes(connection?.effectiveType || '');
    ...
    <div className="login-container">
      ...
      <div className="login-card-wrapper">
        ...
        >
          ...
          >
            <span className="company-name">Raj Communication</span>
          </motion.h1>
              ...
              {success ? (
                ...
                >
                  ...
                  <div className="success-text">
                    ...
                    <p>
                      Redirecting to {redirectingTo === 'admin' ? 'Admin' : 'User'} Dashboard...
                    </p>
      ...
      <style>{`
        ...
        .canvas-fallback {
          ...
          height: 100%;
          background:
            radial-gradient(circle at 25% 20%, rgba(255, 215, 0, 0.16), transparent 45%),
            radial-gradient(circle at 80% 80%, rgba(28, 179, 255, 0.14), transparent 42%),
            linear-gradient(135deg, #090d15 0%, #0f1728 48%, #101c2c 100%);
        }
